        ...
        do {
            ...
            while (current.next != null) {
                if (current.priority > current.next.priority) {
                    ...
                    String tempcat = current.category;
                    current.category = current.next.category;
                    current.next.category = tempcat;

                    String temp_rec = current.recurrence;
                    current.recurrence = current.next.recurrence;
                    current.next.recurrence = temp_rec;
                    swapped = true;
                }
